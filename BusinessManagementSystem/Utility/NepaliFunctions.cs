    ...
    public class NepaliDateService
    {
        ...
        private static void InitializeData()
        {
            bs = new Dictionary<int, int[]>
            {
                ...
                {83, new int[] {2083, 31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}},
                {84, new int[] {2084, 31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}},
                {85, new int[] {2085, 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31}},
                {86, new int[] {2086, 31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}},
                {87, new int[] {2087, 31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}},
                {88, new int[] {2088, 31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}},
                {89, new int[] {2089, 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31}},
