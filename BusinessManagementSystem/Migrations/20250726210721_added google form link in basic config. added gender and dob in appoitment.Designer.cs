...
namespace TattooAppointmentSystem.Migrations
{
    ...
    [Migration("20250726210721_added google form link in basic config. added gender and dob in appoitment")]
    partial class addedgoogleformlinkinbasicconfigaddedgenderanddobinappoitment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.AdvancePayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.BasicConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.MenuRole", b =>
                {
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.OTP", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.PaymentHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.Referal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.Tip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.AdvancePayment", b =>
                {
                    b.HasOne("TattooAppointmentSystem.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.Appointment", b =>
                {
                    b.HasOne("TattooAppointmentSystem.Models.Referal", "Referal")
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.MenuRole", b =>
                {
                    b.HasOne("TattooAppointmentSystem.Models.Menu", "Menu")
                        .WithMany("MenuRoles")
                        .HasForeignKey("MenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TattooAppointmentSystem.Models.Role", "Role")
                        .WithMany("MenuRoles")
            ...
            modelBuilder.Entity("TattooAppointmentSystem.Models.Payment", b =>
                {
                    b.HasOne("TattooAppointmentSystem.Models.Appointment", "Appointment")
                        .WithOne("Payment")
                        .HasForeignKey("TattooAppointmentSystem.Models.Payment", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
